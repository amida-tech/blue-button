...
describe('immunizations', function () {
  it('no indications', function () {
    ...
    expect(result.data.immunizations[0].indications).not.toBeDefined();
  });
  ...
  it('one indication', function () {
    ...
    expect(result.data.immunizations[0].indications.length).toBe(1);

    var indication = result.data.immunizations[0].indications[0];
  ...
  it('multiple indications', function () {
    ...
    expect(result.data.immunizations[0].indications.length).toBe(2);
  });
});
