...
describe('try skewed sample data from app.', function () {
    it('should still be same', function () {
        ...
        fs.writeFileSync("test/fixtures/files/parse_gen_parse/generated/CCD_1_generated_new.json", JSON.stringify(result, null, 4));
        ...
        // write ccda
        fs.writeFileSync("test/fixtures/files/parse_gen_parse/generated/CCD_1_generated_new.xml", xml);

        // parse generated ccda
        var result2 = bb.parseString(xml);
        // write the parsed json from the generated ccda
        fs.writeFileSync("test/fixtures/files/parse_gen_parse/generated/CCD_1_generated_2_new.json", JSON.stringify(result2, null, 4));

        // re-generate
        var xml2 = bb.generateCCDA(result2).toString();
        fs.writeFileSync("test/fixtures/files/parse_gen_parse/generated/CCD_1_generated_2_new.xml", xml2);
