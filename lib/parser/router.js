...
var components = {
   ...
   ccda_encounters: require('./ccda/encounters').encountersSection,
   ccda_procedures: require('./ccda/procedures').proceduresSection,
   ccda_socialHistory: require('./ccda/socialHistory').socialHistorySection
};
