...
var generateComponents = function (version) {
  ...
  return {
    ...
    ccda_nutrition: require("./ccda/sections/nutrition").nutritionSection(version)[0],
    ...
    ccda_functional_statuses: require('./ccda/sections/functional_status').functionalStatusSection(version)[0],
    ccda_hospital_discharge_instructions: require('./ccda/sections/hospital_discharge_instructions').hospital_discharge_instructions_section(version)[0],
    ccda_hospital_discharge_medications: require('./ccda/sections/hospital_discharge_medications').hospital_discharge_medications_section(version)[0],
    ccda_reason_for_referral: require('./ccda/sections/reason_for_referral').reason_for_referral_section(version)[0],
    ...
    ccda_nutrition: require("./ccda/sections/nutrition").nutritionSection(version)[1],
    ...
    ccda_functional_statuses_entry: require('./ccda/sections/functional_status').functionalStatusSection(version)[1],
    ccda_hospital_discharge_medications_entry: require('./ccda/sections/hospital_discharge_medications').hospital_discharge_medications_section(version)[1],
  };
};
