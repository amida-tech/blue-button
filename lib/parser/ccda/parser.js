...
Parser.prototype.init = function (jsPath, cardinality, xpath, component, sourceType) {
...
Parser.prototype.run = function(parentInstance, node, sourceType) {
    ...
    var jsVal = matches.map(function(match, i) {
        if (component && component.componentName) {
            ...
            if (component.parsers.length > 0) {
                instance.run(match);
            } else {
                instance.run(Processor.asString(match));
            }
            return instance;
        } else if (component) {
