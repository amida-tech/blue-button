...
ConceptDescriptor.fields([
  ["name", "0..1", "@displayName"],
  ["originalText", "0..1", "h:originalText", TextWithReference],
  ["code", "1..1", "@code"],
  ["system", "1..1", "@codeSystem"],
  ["code_system_name", "0..1", "@codeSystemName"],
  ["nullFlavor", "0..1", "@nullFlavor"],
  ...
  .cleanupStep(Cleanup.removeField('system'));
...
augmentSimplifiedCode.replaceSchema = function(current) {
    return "string";
}
...
var Telecom = exports.Telecom = Component.define("Telecom")
  .fields([
    ["value", "1..1", "@value"],
    ["use", "0..1", "@use", SimpleCode("2.16.840.1.113883.5.1119")]
  ]);

//TODO:  Figure out how to use regex with this to filter.
var Email = exports.Email = Component.define("Email")
  .fields([
    ...
    if (this.js.address) {
        this.js.address = this.js.address.substring(0, 7) === "mailto:" ? this.js.address.substring(7) : '';
    }
    if (this.js.type) {
        this.js.type = '';
    }
...
var Organization = exports.Organization = Component.define("Organization")
  .fields([
    ...
    ["email", "0..*", "h:telecom[starts-with(@value,'mailto:')]", Email],
    ["phone", "0..*", "h:telecom[starts-with(@value,'tel:')]", Phone]
  ]);
...
.fields([
    ...
    ["loc_type", "1..1", "h:code", ConceptDescriptor],
    ["addresses", "0..*", "h:addr", Address],
    ["phones", "0..*", "h:telecoms", Telecom]
]);
