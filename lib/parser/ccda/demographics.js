...
exports.Patient = Component.define("Patient")
  .fields([
    ...
    ["marital_status", "0..1", "h:patient/h:maritalStatusCode", shared.SimplifiedCode.shall({
    ...
    ["languages", "0..1", "h:patient/h:languageCommunication", LanguageCommunication],
