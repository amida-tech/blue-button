    ...
    var author = component.define("author")
         .fields([
             ...
             [version == "" ? "name": "organization", "0..1", 
                "(h:assignedAuthor/h:representedOrganization | h:assignedAuthor/h:assignedPerson/h:name)[last()]", 
                (version == "" ? shared.IndividualName : shared.Organization)]
        ]);
...
// ***************************************************************************
    if (version == "") { 
        ...
        var MedicationPerformer = component.define("MedicationPerformer")
            .fields([
                ["identifiers", "0..*", "h:assignedEntity/h:id", shared.Identifier],
                ["address", "0..1", "h:assignedEntity/h:addr", shared.Address],
        ...
        var MedicationActivity = component.define("MedicationActivity")
            ...
            .fields([
                ...
                ["performer", "0..1", "h:performer", MedicationPerformer],
                ["drug_vehicle", "0..1", MedicationDrugVehicle.xpath(), MedicationDrugVehicle],
