  ...
  if (version === "") {//default version
    ...
    immunizationMedicationInformation = component.define("immunizationMedicationInformation")
      ...
      .fields([
        ...
        // ["product", "1..1", "h:manufacturedMaterial/h:code", shared.ConceptDescriptor],
        ["manufacturer", "0..1", "h:manufacturerOrganization/h:name/text()"],
        ["material", "1..1", "h:manufacturedMaterial/h:name/text()"]
      ]);
...
*/
    ...
    var MedicationDispense = component.define("MedicationDispense")
      ...
      .fields([
        ...
        ["product", "0..1", "h:product/h:manufacturedProduct", medicationInformation],
        ["immunization", "0..1", "h:product/h:manufacturedMaterial", immunizationMedicationInformation]
      ]);
    ...
    medicationActivity = component.define("medicationActivity")
      .fields([
        ...
        /* array, explained:
              [0] => name of array elements (appear to match the model objects);
              [1] => cardinality (zero or one, exactly 1, or many);
              [2] => ns:xml tag[@attributes];
              [3] => processor, built-in or user-defined*/
    ...
    immunizationMedicationInformation = component.define("immunizationMedicationInformation")
      .templateRoot("2.16.840.1.113883.10.20.1.54")
      .fields([
        ["identifiers", "0..*", "h:id", shared.Identifier],
        ["products", "0..1", "h:code", shared.ConceptDescriptor],
        ["manufacturer", "0..1", "h:manufacturerOrganization/h:name/text()"],
        ["material", "1..1", "h:manufacturedMaterial/h:name/text()"]
      ]);
