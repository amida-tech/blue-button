...
var exportAllergiesSection = function (version) {
    ...
    allergyReaction.fields([
        ...
        ["severity", "0..1", "h:entryRelationship/h:observation/h:value", allergySeverityObservation]
    ]);
    ...
    var allergyIntoleranceObservation = component.define("allergyIntoleranceObservation"); // intolerance observation
    allergyIntoleranceObservation.fields([
            ["date_time", "1..1", "../h:effectiveTime", shared.EffectiveTime],
            ["code", "0..1", "@code"],
            ["name", "0..1", "@displayName"],
            ["code_system_name", "0..1", "@codeSystemName"],
            ["severity", "0..1", "../*/*/h:templateId[@root='2.16.840.1.113883.10.20.22.4.8']/../h:value", allergySeverityObservation]
    ]);
    ...
    allergyObservation.fields([
        ...
        ["intolerance", "0..1", "h:value", allergyIntoleranceObservation],
        ["status", "0..1", "*/*/h:templateId[@root='2.16.840.1.113883.10.20.22.4.28']/../h:value", allergyStatusObservation],
