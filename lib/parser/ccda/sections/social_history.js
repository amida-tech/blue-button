...
var exportSocialHistorySection = function (version) {
  ...
  socialHistorySectionUnion.templateRoot([[sectionIDs.SocialHistorySection, sectionIDs.SocialHistorySectionEntriesOptional]])
  socialHistorySectionUnion.fields([
    ["smoking_statuses", "0..*", socialHistoryObservation.xpath(), socialHistoryObservation],
    ["tobacco_use", "0..*", tobaccoUse.xpath(), tobaccoUse]
  ])
  ...
  socialHistorySectionUnion.cleanupStep(function () {
    var typeMap = {
      [sectionIDs.SocialHistorySection]: "smoking_statuses", // ccda
