...
var exportSocialHistorySection = function (version) {
  ...
  socialHistorySectionUnion.templateRoot([clinicalStatementsIDs.TobaccoUse, clinicalStatementsIDs.SocialHistoryObservation])
  socialHistorySectionUnion.fields([
    // xpaths update - find template by ID, and go  up /.. a level
    ["smoking_statuses", "0..1", socialHistoryObservation.xpath(), socialHistoryObservation],
    ["tobacco_use", "0..1", tobaccoUse.xpath(), tobaccoUse],
  ])
  ...
  socialHistorySectionUnion.cleanupStep(function () {
    var typeMap = {
      [sectionIDs.SocialHistorySection]: "smoking_statuses",
      [sectionIDs.SocialHistorySectionEntriesOptional]: "smoking_statuses",
      [clinicalStatementsIDs.TobaccoUse]: "tobacco_use",
    };
  ...
  var socialHistorySection = component.define("socialHistorySection")
    socialHistorySection.templateRoot([sectionIDs.SocialHistorySection, sectionIDs.SocialHistorySectionEntriesOptional]);
