...
var exportImmunizationsSection = function (version) {
    ...
    var immunizationRefusal = component.define('immunizationRefusal')
        .fields([
            ["identifiers", "0..*", "h:id", shared.Identifier],
            ["reason", "0..1", "h:code/@code", shared.SimpleCode("2.16.840.1.113883.5.8")],
            ["code", "0..1", "h:code", shared.ConceptDescriptor]
        ]);
    ...
    var ImmunizationActivity = component.define("ImmunizationActivity")
        ...
        .fields([
            ...
            ["refusal", "0..1", "h:entryRelationship/h:observation", immunizationRefusal],
        ]);
