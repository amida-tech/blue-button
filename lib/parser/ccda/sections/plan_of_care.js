// TASK:
/* 
Use parser/ccda/sections/procedures.js as model/base for implementing the parser for plan_of_care.js.
When the parser is implemented, need to include it in: parser/ccda/ccd.js and plarser/ccda/router.js.
Then, look into writing a validator for the parser/model.
Test, with test-plan_of_care.js. 
...
entry.cleanupStep(function() {
    var typeMap = {
        "2.16.840.1.113883.10.20.22.4.44": "observation",
...
plan_of_care_section.templateRoot(['2.16.840.1.113883.10.20.22.2.10']);
