...
var exportProceduresSection = function (version) {
    ...
    */
    ...
    entry.fields([
        ...
        ["physicalQuantity", "0..1", "h:value[@xsi:type='PQ']", shared.PhysicalQuantity],
    ...
    entry.cleanupStep(cleanup.extractAllFields(['codedValue']));
    entry.cleanupStep(cleanup.extractAllFields(['physicalQuantity']));
    ...
    observation.cleanupStep(cleanup.extractAllFields(['codedValue']));
    observation.cleanupStep(cleanup.extractAllFields(['physicalQuantity']));
    ...
    procedure.cleanupStep(cleanup.extractAllFields(['codedValue']));
    procedure.cleanupStep(cleanup.extractAllFields(['physicalQuantity']));
    ...
    act.cleanupStep(cleanup.extractAllFields(['codedValue']));
    act.cleanupStep(cleanup.extractAllFields(['physicalQuantity']));
    ...
    mutex.fields([
        ...
        // ["contents", "0..1", ".//h:templateId[@root='2.16.840.1.113883.10.20.22.4.12']/..", act]
        ["contents", "0..1", ".", act],
        // ["contents", "0..1", util.format(".//h:templateId[@root='%s']/..", '2.16.840.1.113883.10.20.22.4.12'), act],
        // ["contents", "0..1", util.format(".//h:templateId[@root='%s']/..", '2.16.840.1.113883.10.20.22.4.13'), observation],
        // ["contents", "0..1", util.format(".//h:templateId[@root='%s']/..", '2.16.840.1.113883.10.20.22.4.14'), procedure],
    ]);
    mutex.cleanupStep(cleanup.extractAllFields(["contents"]));
