...
var exportProceduresSection = function (version) {
    ...
    */
    ...
    observationEntry.cleanupStep(cleanup.extractAllFields(['value']));
    ...
    procedureEntry.cleanupStep(cleanup.extractAllFields(['value']));
    ...
    actEntry.cleanupStep(cleanup.extractAllFields(['value']));
