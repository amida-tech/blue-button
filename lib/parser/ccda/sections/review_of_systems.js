...
var exportReviewOfSystemsSection= function (version) {
  ...
  var exportReviewOfSystemsSection = component.define("socialHistorySection")
  exportReviewOfSystemsSection.templateRoot([
    sectionIDs.ReviewOfSystemsSection
  ]);
  exportReviewOfSystemsSection.fields([
    ["entry", "0..*", exportReviewOfSystemsSection.xpath(), reviewOfSystemsSection]
  ])

  exportReviewOfSystemsSection.cleanupStep(cleanup.replaceWithField('entry'));

  return [exportReviewOfSystemsSection];
}
