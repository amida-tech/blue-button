...
var resolveReference = cleanup.resolveReference = function (input, context) {
    if ((input !== null) && (input !== undefined) && context) {
...
cleanup.augmentSimpleCode = function (oid) {
    var f = function (input) {
        if (input) {
            var cs = css.find(oid);
            if (cs) {
                return cs.codeDisplayName(input);
            }
        }
        return input;
    };
...
cleanup.augmentConcept = function (input) {
    if (input) {
        if ((input.nullFlavor !== undefined) && (input.nullFlavor !== undefined) && !input.original_text) {
            return null;
        }
