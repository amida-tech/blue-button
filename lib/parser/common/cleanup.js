...
var augmentAge = cleanup.augmentAge = function () {
    ...
    if (units) {
        var cs = css.getCodeSystem("2.16.840.1.113883.11.20.9.21");
        if (cs) {
            var value = cs.getName(units);
            if (value) {
                this.js = value;
            }
        }
...
cleanup.augmentSimpleCode = function (oid) {
    var f = function () {
        if (this.js) {
            var cs = css.getCodeSystem(oid);
            if (cs) {
                this.js = cs.getName(this.js);
            }
        }
    };
    return f;
    ...
    var f = function () {
        if (this.js) {
            if (this.js.name) {
                ...
                var cs = css.getCodeSystem(oid);
                if (cs) {
                    var name = cs.getName(this.js.code);
                    if (name) {
                        this.js = name;
                    }
                }
