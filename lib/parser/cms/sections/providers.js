...
function processProviderChild(rawChildObj) {
    ...
    for (var key in rawChildObj) {
        ...
        health care provider */
            ...
            childObj.role = commonFunctions.getFunction('cda_coded_entry')(value);
        }
        //this field, I am not sure where this goes.
            ...
            */
            var person = {};
            person.name = commonFunctions.getFunction('cda_name')(childObj.name);
            delete childObj.name;
            childObj.person = person;
            childObj.type = 'person';
        }
