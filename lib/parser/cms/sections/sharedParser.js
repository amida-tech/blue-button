  ...
  if(intObj instanceof Array){ // start recursing thorugh the array of objects
    ...
    for(var intKey in intObj){
        ...
        if(bbKey in modelTemplate){
          ...
          var writeValueResult = writeValue(intKey, bbKey, valueOfIntObj, valueTemplate, unfilledKeys, valueIsArray);//this needs to be changed to accomodate different functions later
