...
function processClaimLine(claimLines) {
    ...
    for (var key in claimLines) {
        ...
        if (ignoreValue(value)) {
            ...
            /*this is a medicare personal identification number, wasn't sure if it belonged in the code or if
            we should even parse it at all */
            var parsedIdentifier = commonFunctions.getFunction('cda_id')("MEDICARE PIN",value);
