...
var keyMapper = require('./keyMapper.js');

var commonFunctions = require('./commonModelFunctionRouter.js');
...
function parseDemographics(intObj) {
    ...
    var commonMap = keyMapper.getMap('common');
    for(key in intObj){
        key = key.toLowerCase();
        value = intObj[key];
