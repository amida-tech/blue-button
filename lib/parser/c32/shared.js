...
var IndividualName = exports.IndividualName = component.define('IndividualName')
    ...
    ]).cleanupStep(cleanup.augmentIndividualName).cleanupStep(commonCleanup.clearNulls);
