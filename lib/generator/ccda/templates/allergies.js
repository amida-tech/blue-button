            ...
            .node('act')
                ...
                xmlDoc = xmlDoc.node('entryRelationship') // allergy observation
                    ...
                    .node('observation')
                        ...
                        xmlDoc = libCCDAgen.effectiveTime(xmlDoc, libCCDAgen.getTimes(data[i]["intolerance"]["date_time"]));
                        xmlDoc = libCCDAgen.value(xmlDoc, data[i]["intolerance"], "CD", (i + 1));
                        ...
                        xmlDoc = xmlDoc.node('entryRelationship')// Allergy reaction observation 
                            ...
                            .node('observation').attr({classCode: "OBS"})
                                ...
                                xmlDoc = libCCDAgen.effectiveTime(xmlDoc, libCCDAgen.getTimes(data[i]["reaction"][0]["date_time"]));
