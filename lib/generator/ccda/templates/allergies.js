...
function writeXML(data, codeSystems) {
    var xml = {};
    xml = loadAllergies(data, codeSystems);
    return xml;
}


function loadAllergies(data, codeSystems) {
    ...
    // libCCDAGen.header(doc, "2.16.840.1.113883.10.20.22.2.6", "2.16.840.1.113883.10.20.22.2.6.1", 
