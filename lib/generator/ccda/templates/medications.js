                ...
                xmlDoc = xmlDoc.node('entry').attr({typeCode: "DRIV"})
                    .node('substanceAdministration').attr({classCode: "SBADM"}).attr({moodCode: "EVN"})
                        ...
                        .node('effectiveTime').attr({"xsi:type": "IVL_TS" })
                            ...
                            .node('high').attr(time == undefined ? {nullFlavor: "UNK"} : {value: time[2]}).parent()
                        .parent()
                        ...
                        xmlDoc = libCCDAGen.performerRevised(xmlDoc, undefined, {"id": undefined, "extension": undefined, "addr": undefined, "tel": undefined, 
                                            "repOrg": "generic", "assignedP": undefined, "templateId_in": undefined});
                        ...
                        .node('entryRelationship').attr({typeCode: "REFR"})
                            .node('supply').attr({classCode: "SPLY"}).attr({moodCode: "INT"})
                                ...
                                xmlDoc = libCCDAGen.performerRevised(xmlDoc, undefined, {"id": "2.16.840.1.113883.19.5.9999.456", "extension": "2981823", "addr": "generic", "tel": undefined, 
                                            "repOrg": undefined, "assignedP": undefined, "templateId_in": undefined});
                        ...
                        xmlDoc = xmlDoc.node('entryRelationship').attr({typeCode: "REFR"})
                            .node('supply').attr({classCode: "SPLY"}).attr({moodCode: "EVN"}) // medication dispense
                                ...
                                xmlDoc = xmlDoc.parent();
                                xmlDoc = libCCDAGen.performerRevised(xmlDoc, undefined, {"id": "2.16.840.1.113883.19.5.9999.456", "extension": "2981823", "addr": "generic", "tel": undefined, 
                                            "repOrg": "generic", "assignedP": "generic", "templateId_in": undefined});
                            xmlDoc = xmlDoc.parent()
                        .parent();
