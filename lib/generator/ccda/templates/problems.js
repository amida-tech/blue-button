...
module.exports = function (data, codeSystems, isCCD, CCDxml) {
    ...
    for (var i = 0; i < entries[0].length; i++) {
        ...
        .node('templateId').attr({
            ...
            .node('id').attr({
                root: data[i]["source_list_identifiers"] ? data[i]["source_list_identifiers"][0]["identifier"] : "UNK"
            }).parent()
            .node('code')
            .attr({
                code: "CONC"
        ...
        .node('templateId').attr({
            ...
            .node('id').attr(data[i]["identifiers"] !== undefined ? {
        ...
        if (data[i]["problem"]) {
            xmlDoc = xmlDoc.node('value').attr({
                ...
                .attr({
                    code: data[i]["problem"]["code"]
                })
                .attr({
                    codeSystem: "2.16.840.1.113883.6.96"
                })
                .attr({
                    displayName: data[i]["problem"]["name"]
                }).parent()
        }
        ...
        .node('templateId').attr({
            ...
            .attr({
                displayName: data[i]["patient_status"]
            }).parent()
            .parent()
            .parent()
