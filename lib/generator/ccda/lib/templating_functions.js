...
var value = function(xmlDoc, value, type, oText) {
    if (value) {
        ...
        xmlDoc = xmlDoc.node('value').attr({nullFlavor: "UNK"});
    }
    return xmlDoc;
}
...
var performerRevised = function (xmlDoc, performer, spec) {
    if (performer) {
        ...
        performer["identifiers"][0]["identifier_type"] : "UNK";
...
var entryRelationship = function (xmlDoc, data, type, i, code, subsection) {
    if (type == 'act') {
