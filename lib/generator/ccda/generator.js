...
var genWholeCCDA = function (data) {
    ...
    var xmlDoc = doc.node('ClinicalDocument')
        ...
        xmlDoc = xmlDoc.node('code').attr({codeSystem: "2.16.840.1.113883.6.1"}).attr({codeSystemName: "LOINC"})
        ...
        .node('recordTarget')
            ...
            libCCDAGen.id(xmlDoc, data.demographics && data.demographics.identifiers);
