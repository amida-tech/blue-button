...
var gen = function(data) {
    ...
    var xml = require('./templates/' + sectionNames[sectionNumber] + '.js')(data, codeSystems);
...
var genWholeCCDA = function(data) {
    console.log("hello");
    for (var i = 1; i <= 10; i++) {
        console.log(data[sectionNames[i]] != undefined);
        console.log(sectionNames[i].toUpperCase());
        // console.log(data[sectionNames[i]]);
        console.log( gen(data[sectionNames[i]]) );
    }
}
