...
*/
var gen = function(data, CCD, xmlDoc, section) {
    return data !== undefined ? 
    require('./templates/' + section + '.js')(data, codeSystems, CCD, xmlDoc) : xmlDoc;
};
    ...
    var xmlDoc = doc.node('ClinicalDocument').attr({"xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance"})
        ...
        .node('recordTarget')
           .node('patientRole')
               ...
               xmlDoc = gen(data[sectionNames[1]], true, xmlDoc, sectionNames[1]); // demographics is in the header
