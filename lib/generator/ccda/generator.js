...
var codeSystems = libCCDAGen.getCodeSystems();
...
<<<<<<< HEAD
        // console.log("Section count is: " + count_sections);
...
=======
    ...
    if (count_sections > 0) {
        ...
        for (var i = 2; i <= 10; i++) {
            xmlDoc = gen(data[sectionNames[i]], true, xmlDoc, sectionNames[i]);
>>>>>>> 6ec49e357ab4529cc150051ff61e1273dc5c00f4
        }
    }
